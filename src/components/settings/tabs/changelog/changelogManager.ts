...
const RAINCORD_RELEASES_REPO = "yocrypto431/raincord"; // Update when you create your repo
const RAINCORD_REPO_URL = `https://github.com/${RAINCORD_RELEASES_REPO}`;
