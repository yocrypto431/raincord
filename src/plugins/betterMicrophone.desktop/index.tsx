...
const MicrophoneUserAreaButton: UserAreaButtonFactory = ({ iconForeground }: UserAreaRenderProps) =>
    <UserAreaButton
        tooltipText="Microphone Settings"
        icon={<MicrophoneSettingsIcon className={iconForeground} width={20} height={20} />}
...
export default definePlugin({
    ...
    userAreaButton: { icon: MicrophoneSettingsIcon, render: MicrophoneUserAreaButton },
    start(): void {
        initMicrophoneStore();
