...
const ScreenshareUserAreaButton: UserAreaButtonFactory = ({ iconForeground }: UserAreaRenderProps) =>
    <UserAreaButton
        tooltipText="Screenshare Settings"
        icon={<ScreenshareSettingsIcon className={iconForeground} width={20} height={20} />}
...
export default definePlugin({
    ...
    userAreaButton: { icon: ScreenshareSettingsIcon, render: ScreenshareUserAreaButton },
    patches: [
        {
