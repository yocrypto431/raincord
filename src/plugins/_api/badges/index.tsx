...
let RAINCORDBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const raincordBadgesData = await loadBadges("https://gist.githubusercontent.com/raincord/29ff0da4ebd5a7e36acdf97be24f28c9/raw/badges.json", noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    RAINCORDBadges = raincordBadgesData;
}
...
export default definePlugin({
    ...
    getRAINCORDBadges(userId: string) {
        try {
            const userBadges = RAINCORDBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "RAINCORD Badge",
