...
import IconsTab from "@raincordplugins/iconViewer/components/IconsTab";
...
import { CreateThemeTab } from "@raincordplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@raincordplugins/createTheme/components/PencilSparkleIcon";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the RAINCORD settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("RAINCORD_stealthMode") === "1") return ""; } catch { }
                return "RAINCORD Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("RAINCORD_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`RAINCORD ${gitHashShort}${getVersionInfo()}`];
