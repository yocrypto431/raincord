...
const RAINCORDDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(RAINCORDDir, "Uninstall RAINCORD.exe"));

export const DATA_DIR =
    process.env.RAINCORD_USER_DATA_DIR || (PORTABLE ? join(RAINCORDDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `RainCord/${app.getVersion()} (https://github.com/yocrypto431/raincord)`;
