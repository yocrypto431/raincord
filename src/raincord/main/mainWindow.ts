...
function initMenuBar(win: BrowserWindow) {
    ...
    const subMenu = [
        {
            label: "About RAINCORD",
            click: createAboutWindow
        },
        {
            label: "Force Update RAINCORD",
            async click() {
            ...
            toolTip: "RAINCORD will automatically restart after this operation"
        },
        {
