...
import { Logger } from "@RAINCORD/types/utils";
import { findLazy, onceReady } from "@RAINCORD/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@RAINCORD/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("RAINCORDRPC", "#5865f2");
