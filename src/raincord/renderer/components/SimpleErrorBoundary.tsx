...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@RAINCORD/types/components";
import { FluxDispatcher, InviteActions } from "@RAINCORD/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure RAINCORD and RAINCORD are fully up to date. You can get help in our{" "}
