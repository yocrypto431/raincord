...
import {
    ...
    RestartIcon,
    Span
} from "@RAINCORD/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@RAINCORD/types/webpack/common";
...
const logger = new Logger("RAINCORDScreenShare");
