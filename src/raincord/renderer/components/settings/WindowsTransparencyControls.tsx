...
import { Heading, Paragraph } from "@RAINCORD/types/components";
import { Margins } from "@RAINCORD/types/utils";
import { Select } from "@RAINCORD/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind RAINCORD for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
