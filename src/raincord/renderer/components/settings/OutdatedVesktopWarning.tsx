...
import { Button, Card, HeadingTertiary, Paragraph } from "@RAINCORD/types/components";
import { useAwaiter } from "@RAINCORD/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your RAINCORD is outdated!</HeadingTertiary>
