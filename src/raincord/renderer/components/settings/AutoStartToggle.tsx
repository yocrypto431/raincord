...
import { useState } from "@RAINCORD/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start RAINCORD on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start RAINCORD minimized when starting with system"}
