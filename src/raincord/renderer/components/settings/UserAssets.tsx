...
import { BaseText, Button, FormSwitch } from "@RAINCORD/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@RAINCORD/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`RAINCORD://assets/${asset}?v=${version}`}
                    alt=""
