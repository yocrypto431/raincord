...
import { classNameFactory } from "@RAINCORD/types/api/Styles";
import { BaseText, Divider, ErrorBoundary } from "@RAINCORD/types/components";
...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "RAINCORD" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while RAINCORD is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for RAINCORD",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make RAINCORD minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the RAINCORD window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscellaneous: [
        ...
        },
        {
            ...
            description: "Opens links in a new RAINCORD window instead of your web browser",
            defaultValue: false
        }
    ],
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the RAINCORD Settings tab. If this issue persists, try to right click the RAINCORD tray icon, then click 'Repair RAINCORD'. And make sure your RAINCORD is up to date."
    }
);
